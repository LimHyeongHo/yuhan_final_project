...
import com.example.aisearchtrend.repository.SearchLogRepository;
...
public class SearchTrendService {
    ...
    public Map<String, Integer> getAllSearchCounts() {
        return searchLogRepository.findAll().stream()
                .sorted(Comparator.comparingInt(SearchLog::getSearchCount).reversed())
